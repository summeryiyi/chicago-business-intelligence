...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/driven-park-348917:asia-east1:mypostgres sslmode=disable port = 5432"
