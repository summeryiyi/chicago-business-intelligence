...
func main() {
	...
	//db_connection := "user=root dbname=chicago_business_intelligence password=root host=postgresdb sslmode=disable port = 5433"

	//Option 4
	//Database application running on Google Cloud Platform.
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/voltaic-talent-348919:asia-east1:mypostgres sslmode=disable port = 5432"
...
func GetTaxiTrips(db *sql.DB) {
	...
	geocoder.ApiKey = "AIzaSyBx3Nk2icCrBW0gXFLzfrAHcZ3s87rR23I"
